...
async def run():
    ...
    print(interface.yumi.left.max_position)
    print(interface.yumi.left.min_position)
    print(interface.yumi.right.max_position)
    print(interface.yumi.right.min_position)
    ...
    # await interface.go_linear_single
