...
if __name__ == '__main__':
    ...
    # [Cloud version] Authenticate with your account API key by either:
    # Set `JACOBI_API_KEY` and `JACOBI_API_SECRET` environment variable, or call
    # planner.set_authentication('JKIJEFH5DWWVXOVFBNQJ', 'Mro1Ax3QIll7OkfB9Q3wD5+sEd1U4eBRKqGs5WNG')
